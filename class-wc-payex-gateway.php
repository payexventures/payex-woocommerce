    ...
    class WC_PAYEX_GATEWAY extends WC_Payment_Gateway
    {
        ...
        public function process_payment($order_id)
        {
            ...
            if ($token)
            {
                ...
                $payment_link = $this->get_payex_payment_link($url, $order_data, $order_items, $this->get_return_url($order) , $order->get_checkout_payment_url() , WC()
                    ->api_request_url(get_class($this)) , $token);
